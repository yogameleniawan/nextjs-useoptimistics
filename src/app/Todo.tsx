    ...
    return (
        <>
            ...
            <div className="flex flex-col space-y-2 my-2">
                {optimisticTodo.map((todo: any, index: number) => (
                    <div className="w-full">
                        <div className={`bg-gray-100 rounded flex p-4 h-full items-center text-black ${!!todo.sending ? 'opacity-20' : ''}`}>
            ...
            <form action={formAction} ref={formRef} className="flex flex-col">
                <input type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-200 dark:border-gray-200 dark:placeholder-gray-400 dark:text-black dark:focus:ring-red-500 dark:focus:border-blue-500 my-5" name="todo" placeholder="Add Todo Today" autoComplete="off" />
